...
were encoded independently with short LDGM codes.    In
...
\begin{keywords}
Decoding of multiple correlated sources, large scale sensor networks, bit-flipping decoding algorithms.
\end{keywords}
...
The efficient transmission of information from separate correlated sources to a remote sink node is a challenging problem \cite{raheli2010}, \cite{raheli2011}.
This problem becomes more challenging when the number of sources is very large. This is the case of a large scale wireless sensor network \cite{joao}.
In \cite{joao}
***************************
...
falar sobre paralelismo dos algoritmos (raheli2011 e japoneses). as informaçoes dos outros decodificadores sao como side information. dai descrever resultados
...
*********************************
 ...
 It is reasonable to assume that the separated sensor nodes  transmit their observations over orthogonal noisy channels.
...
It is not difficult to show that the higher the absolute value of the correlation $corr(u^{0},u^{i})$, the greatest the mutual information $I(u^{0},u^{i})$. However, in the system model of Section \ref{sec:SystemModel}, source $u_{0}$ plays the role of a common hidden source \cite{raheli}.  This implies that in a real situation one cannot estimate the mutual informations $I(u^{0},u^{i})$, $i=1, 2, \ldots, I$.
...
"The results are highly dependent on the choice of the source model.



\begin{thebibliography}{1}

\bibitem{raheli2010} M. Martal\`o, G. Ferrari, A. Abrardo, M. Franceschini, and R. Raheli,\emph{ Density evolution-based analysis and design of LDPC codes with a-priori information}, in Proc. Inform. Theory and Applications Workshop (ITA), UCSD, San Diego, CA, USA, February 2010.
...
\bibitem{sbrt12} F. Pujaico, J. Portugheis, \emph{Algoritmos de decodificação abrupta para códigos LDGM}, 30th Brazilian Telecommunications Symposium,
 September 2011,Bras\'{i}lia, Brazil.
...
\bibitem{japao} K. Kobayashi and T. Yamazato and M. Katayama,\emph{Decoding of Separately Encoded Multiple Correlated Sources Transmitted over Noisy Channels},
  IEICE Transactions,  vol. 92-A ,  no 10,pp 2402-2410, October 2009.
...
\bibitem{GLDPCC}
R. G. Gallager, \emph{Low density parity check codes}.  MIT press,
Cambridge, 1963.
